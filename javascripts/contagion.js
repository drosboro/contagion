...
var contagiousness = 1.0;         // the probability that someone "in range" will be infected on a given turn
...
var probability_of_death = 1.0;   // used to determine whether they recover or die
var mean_seconds_to_fate = 8;   // how long it takes (on average) until their fate happens
var st_dev_to_fate = 1;           // makes the actual time to fate a nice normal distribution... sweet, eh?
var allow_immunity = 0;           // if they survive, they'll be immune and can't catch it again.
